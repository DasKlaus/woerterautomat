...
<form method="post">Gib ein Wort ein, mit dem du ein Spiel starten willst.<br>
	...
	<div id="controlgrid">
		<div class="controls"><label for="languageinput">Sprache:</label><select name="language" id="languageinput" onChange="toggleUmlautcontrols(this);">
		...
		<div id="umlautcontrols" class="controls"><label title="SS statt ß, AE statt Ä etc." for="umlautcheckbox">Umlaute substituieren:</label><input type="checkbox" onchange="toggleUmlauts(this);" name="umlauts" value="true" id="umlautcheckbox"<?php echo (isset($_POST['umlauts']) ? ' checked' : '')?>></div>
